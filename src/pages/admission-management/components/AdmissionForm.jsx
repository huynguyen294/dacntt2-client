...
const AdmissionForm = ({ defaultValues = {}, editMode, onReload }) => {
  ...
  const { data: courseData, isLoading: courseLoading } = useQuery({
    ...
    queryFn: () => courseApi.get(null, ORDER_BY_NAME, null, statusActive, ["fields=:basic"]),
  });
  ...
  const { data: classData, isLoading: classLoading } = useQuery({
    ...
    queryFn: () => classApi.get(null, ORDER_BY_NAME, null, classFilters, ["fields=:basic"]),
  });
            ...
            <Controller
              ...
              render={({ ref, name, defaultValue, value, setValue }) => (
                <Autocomplete
                  ...
                  selectedKey={user.role === "consultant" ? user.id.toString() : value && value.toString()}
